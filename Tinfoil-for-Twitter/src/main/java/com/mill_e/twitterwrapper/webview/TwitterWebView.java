...
public class TwitterWebView extends WebView {
    ...
    private TwitterWebViewClient mWebViewClient = null;
    private TwitterWebChromeClient mWebChromeClient = null;
     ...
     */
    public TwitterWebView(Context context, AttributeSet attrs, int defStyle) {
     ...
     *
     * @param listener {@link TwitterWebChromeClient.WebChromeClientListener}. It must be
     *                 in the Activity context.
     */
    public void setWebChromeClientListener(TwitterWebChromeClient.WebChromeClientListener listener) {
        if (!mInitialized || (mWebChromeClient == null)) {
            throw new IllegalStateException("The WebView must be initialized first.");
        }
     ...
     *
     * @param listener {@link TwitterWebViewClient.WebViewClientListener}. It must be
     *                 in the Activity context.
     */
    public void setWebViewClientListener(TwitterWebViewClient.WebViewClientListener listener) {
